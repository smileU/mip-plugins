define('mip-plugindemo/mip-pc6-comment', ['require', 'customElement', 'zepto'], function(require) {
    // mip 组件开发支持 zepto
    var $ = require('zepto');
			...
			function readComment(){
				...
				$.ajax({
					...
					success:function(data){
						...
						if(p>=data.PageCount){$('#view-comment .button').val("\u6ca1\u6709\u66f4\u591a\u8bc4\u8bba\u4e86\uff01").attr('disabled',true)};
...
require(['mip-plugindemo/mip-pc6-comment'], function (plugindemo) {
    MIP.registerMipElement('mip-pc6-comment', plugindemo);
});