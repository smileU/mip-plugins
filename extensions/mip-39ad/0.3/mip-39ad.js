		...
		typeof _acK != "undefined" ? d = window._acK : (d = window._acK = function (a) {
				...
				d.extend(d, {
					...
					load : function (a, b, c, f) {
						var e,
						l = /loaded|complete/i,
						j = "ac_js86_$" + d.createCacheBuster();
					...
					megax : function (a) {
						...
						f = a.aid,
						e = a.dAd ? a.dAd : null,
						g = a.js ? a.js : "http://static.mlt01.com/b.js",
						j = a.sburl ? a.sburl : "",
						h = a.cburl ? a.cburl : "",
						o = a.ext ? a.ext : null,
						m = a.ssct ? a.ssct : "",
...
define("extensions/mip-39ad/0.1/mip-39ad", ["require", "zepto", "customElement"], function (require) {
	...
	customElem.prototype.build = function () {
		...
		var asid = element.getAttribute('asid');
		if (asid) {
			var n = require('zepto');
			var i = n(element);
			var script = ['<script type="text/javascript" id="ads_' + asid + '">', 'ac_as_id = ' + asid + ';ac_format = 0;ac_mode = 1;ac_group_id = 1;ac_server_base_url = "d-mip.39.net/";', '</script>'];
...
define("extensions/mip-39ad/0.1/mip-39appgad", ["require", "zepto", "customElement"], function (require) {
	...
	// build 方法，元素插入到文档时执行，仅会执行一次
	customElem.prototype.build = function () {
		window._callbackfunction = function (data) {
			var id = data;
			var n = require('zepto');
			var i = n(element);
		...
		if (adid) {
			var url = "http://app-g.39.net/rel/k14.php?id=" + adid + "&jsonpcallback=_callbackfunction";
